...
* @version $Revision: 1.4 $ $Date: 2009/01/21 11:06:34 $
**/
...
switch($sel){
	case "country":
		...
		echo "<select name=\"".$select_country_name."\" ".$select_style." onchange=\"javascript: SelectRegion('".$sec."', this.value, document.getElementById('region_div'), document.getElementById('city_div'));\">";
	...
	case "upload_base":
		...
		break;
	case "agency_name":
		$agency_name = htmlspecialchars($_GET["agency_name"], 1, "UTF-8");
