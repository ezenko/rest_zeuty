<?php
/**
* Cron file for make feed file in ZIF format.
*
* @package RealEstate
* @subpackage Admin Mode
* @copyright Pilot Group <http://www.pilotgroup.net/>
* @author $Author: aknyazev $
* @version $Revision: 1.1 $ $Date: 2008/11/06 11:17:29 $
**/
...
function EditFeedFile($feed_type){
...
function CreateFeedFile($template_feed_xml, $file_feed_xml, $feed_type){
	...
	if ($feed_type == 2){
		...
		$company["name"]["xml_value"] = $site_name;
		...
		$rss_header["title"]["xml_value"] = GetSiteSettings("rss_title_for_export");		
		$rss_header["description"]["xml_value"] = GetSiteSettings("rss_description_for_export");	
			
		$title_ads_rss = GetSiteSettings("rss_title_ads_for_export");
		$description_ads_rss = GetSiteSettings("rss_description_ads_for_export");
