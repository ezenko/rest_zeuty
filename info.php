...
$subsections = $info_manager->GetSubsectionsList($id, true);
$smarty->assign("subsections", $subsections);

if ($subsection_id) {
	$smarty->assign("subsection_id", $subsection_id);
}
...
if ($section["description"]) {
	$smarty->assign("page_description", $section["description"]);
}
if ($section["keywords"]) {
	$smarty->assign("page_keywords", $section["keywords"]);
}
