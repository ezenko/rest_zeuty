...
<TABLE cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<TR><TD>
		...
		"{if $date.now_date.mday == $week[$cur].mday}selected{/if}>{$week[$cur].mday}</option>
					...
					<tr>
						<td colspan="4" align="left" style="padding-top:10px;">
							<input type="button" value="{$lang.buttons.back}" class="btn_small" onclick="javascript: document.location.href='{$file_name}?sel=my_ad&id_ad={$id_ad}';">
						</td>
					</tr>		
				</table>		
				</form>
