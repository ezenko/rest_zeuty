...
<tr>
	<td style="padding-top: 10px; padding-left: 15px; padding-bottom: 10px;">{$lang.content.choose_text}</td>
</tr>
</table>
...
<tr>
	<td>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td width="15">&nbsp;</td>
				<td class="error">{$lang.content.no_rent_ads}</td>
			</tr>
		</table>
		{else}
			...
			<tr>
				...
				<td valign="top" style="padding-left: 7px; " rowspan="2">
					...
					<tr>
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									<td height="23" valign="top">{if $item.status eq 1}{$lang.content.place_text_1}&nbsp;{$item.place}{$lang.content.place_text_2}{else}{$lang.content.place_text_3}{/if}</td>
								</tr>
								<tr>
									<td height="23" valign="top"><a href="{$item.visited_ad_link}">{$lang.default_select.link_text_4}</a>:&nbsp;{$lang.default_select.link_text_5}&nbsp;{$item.visit_day},&nbsp;{$lang.content.monthly}:&nbsp;{$item.visit_month}</td>
								</tr>		
								...
								{assign var=rows_after_image value=$rows_after_image+1}
								<tr>
									<td height="23" valign="top">{$item.headline}</td>
								</tr>
								{/if}
							</table>
						</td>
					...
					<tr>
						...
						<a href="{$file_name}?sel=match&amp;section=rental_match&amp;id_ad={$item.id}&amp;par={$par}">{$lang.content.match}</a>
						</td>
					</tr>
					</table>
				</td>
